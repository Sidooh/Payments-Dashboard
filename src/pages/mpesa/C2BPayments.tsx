...
import { useMpesaPaymentsQuery } from '@/services/paymentsApi.ts';
import {
    currencyFormat,
    DataTable,
...
import { MpesaC2BCallback, Payment } from '@/utils/types.ts';
                    ...
                    columns={[
                        {
                            ...
                            accessorFn: (p: Payment<MpesaC2BCallback>) => {
                                const name = Str.headline(
                                    `${p.provider?.first_name} ${p.provider?.middle_name} ${p.provider?.last_name}`
                                );
